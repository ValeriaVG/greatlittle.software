---
title: How to come up with a passion project
description: "An opinionated guide on choosing a passion project to build, seeing it through and why you shouldn't build it in public."
category: development
keywords: [productivity, inspiration, ideas]
is_draft: false
created_at: 2026-06-27T04:47:41Z
...
```mermaid
flowchart TD
    Idea["Idea or Pivot"] --> Exp["Experimentation / Creative cocoon"]
    Exp --> Validation{"Do you use the project<br/>every day?"}
    Validation -- No --> Exp
    Validation -- Yes --> Update{"Did you make at least one meaningful update this past month?"}
    Update -- No --> Idea
    Update -- Yes --> Share{"Would it be useful for other people?"}
    Share -- No --> Idea
    Share -- Yes --> DoIt["Great! Share it!"]
```
